<?php
    ...
    $header_width_meta = get_post_meta($konstruk_shop_id, 'header_width_custom', true);
    if ($header_width_meta != ''){
        $header_width = ( $header_width_meta == 'full' ) ? 'container-fluid': 'container';
    }else{
        $header_width = !empty($konstruk_option['header-grid']) ? $konstruk_option['header-grid'] : '';
...
<?php 
    $post_menu_type = get_post_meta($konstruk_shop_id, 'menu-type', true); 
    $post_meta_data = get_post_meta($konstruk_shop_id, 'banner_image', true);
    $content_banner = get_post_meta($konstruk_shop_id, 'content_banner', true); 
          ...
          <div class="row">
            ...
            <div class="col-md-12 text-center">
              <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
                <?php 
                    $post_meta_title = get_post_meta($konstruk_shop_id, 'select-title', true);?>
                    ...
                    <?php } 
                    if(!empty($konstruk_option['off_breadcrumb'])){
                        $rs_breadcrumbs = get_post_meta($konstruk_shop_id, 'select-bread', true);
...
<?php }     
    elseif(!empty($konstruk_option['shop_banner']['url'])){ 
         $shop_banner = $konstruk_option['shop_banner']['url'];?>
                ...
                <div class="col-md-12 text-center">
                  <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>">            
                    <h1 class="page-title"><?php woocommerce_page_title();?></h1>
                     <?php if(!empty($konstruk_option['off_breadcrumb'])){                 
