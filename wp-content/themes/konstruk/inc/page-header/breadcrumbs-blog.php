                    ...
                    <h1 class="page-title">
                        <?php if($content_banner !=''){
                           echo esc_html($content_banner);
                                ...
                                if(!empty($konstruk_option['blog_title'])) { ?>
                                    <?php echo esc_html($konstruk_option['blog_title']);?>
                                    <?php }
                                    else{
                                     esc_html_e('Blog','konstruk');
                                } 
                            }
                        ?>
                    </h1>
                    <?php } 
                     if(!empty($konstruk_option['blog_desc'])){ ?>
                    <p> <?php echo wp_kses_post($konstruk_option['blog_desc']);?></p>
                <?php }
...
<?php }
    elseif(!empty($konstruk_option['blog_banner_main']['url'])) { ?>
