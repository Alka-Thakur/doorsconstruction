<?php
    ...
    if ($header_width_meta != ''){
        ...
        $header_width = $konstruk_option['header-grid'];
            ...
            <div class="col-md-12">
              <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
                <?php 
                    ...
                    ?>
                    <h1 class="page-title">
                        <?php if(!empty($konstruk_option['team_sigle_txt'])){
                            echo esc_html($konstruk_option['team_sigle_txt']);
                         } else {
                            if($content_banner !=''){
                               echo esc_html($content_banner);
                            } else {
                               esc_html_e('Team Single', 'konstruk');
                            }
                        } ?>
                    </h1>

                    <?php } 
                     if(!empty($konstruk_option['team_sigle_txt_desc'])){ ?>
                    <p> <?php echo wp_kses_post($konstruk_option['team_sigle_txt_desc']);?></p>
                <?php }
...
elseif (!empty($konstruk_option['team_single_image']['url'])) {?>
<div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $konstruk_option['team_single_image']['url'] );?>')">
    <div class="<?php echo esc_attr($header_width);?>">
      <div class="row">
        <?php if( !empty( $konstruk_option['footer_icon_animation']['url'])){?>
            <div class="footer-animision-icon">
