<?php
    ...
    if ($header_width_meta != '' && empty($konstruk_option['enable_global'])){  
...
//theme option chekcing
    if($post_meta_data == ''){
        if(!empty($konstruk_option['page_banner_main']['url'])):
        $post_meta_data = $konstruk_option['page_banner_main']['url'];
        endif;
    }  
...
<?php }
 ...
 if($post_meta_bread =='show' || $post_meta_bread ==''){
    ...
    ?>
    <div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $konstruk_option['department_single_image']['url'] );?>')">
        <div class="<?php echo esc_attr($header_width);?>">
          <div class="row">
            <div class="col-md-12">
              <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
