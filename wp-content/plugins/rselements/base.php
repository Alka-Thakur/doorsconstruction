...
final class Rsaddon_Elementor_Pro_Extension {
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/pricing-slider/pricing-slider.php' );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Prelements_Elementor_Pro_Gradient_Heading_Widget());
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Pro_Pricing_Slider_Widget() );		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_pro_Timeline_Widget() );	
