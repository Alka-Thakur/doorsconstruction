	...
	<div class="row">
		 	<?php //******************//
				...
				while($best_wp->have_posts()): $best_wp->the_post();					
					...
					if($pinterest!=''){
						$pin='<a href="'.$pinterest.'" class="social-icon"><i class="fab fa-pinterest-p"></i></a>';
					}
					if($houzz!=''){
						$houz='<a href="'.$houzz.'" class="social-icon"> <i class="fab fa-houzz"></i> </a>';
					}
				?>
						...
						<div class="col-md-7">
							<div class="rsteam_content">
								<div class="team-content">
									...
									<?php if( $fb || $gp || $tw || $ldin || $pinpopup || $houzpopup ): ?>
