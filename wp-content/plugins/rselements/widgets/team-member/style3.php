	...
	<div class="row">
		 	<?php //******************//
				...
				while($best_wp->have_posts()): $best_wp->the_post();					
					...
					$houzz  = get_post_meta( get_the_ID(), 'houzz', true );
					...
					if($pinterest!=''){
						$pin='<li class="linkedin"><a href="'.$pinterest.'" class="social-icon"><i class="fab fa-pinterest-p"></i></a></li>';
					}
					if($houzz!=''){
						$houz='<li class="linkedin"><a href="'.$houzz.'" class="social-icon"> <i class="fab fa-houzz"></i> </a></li>';
					}
				?>
					                  	...
					                  	<?php if( $fb || $gp || $tw || $ldin ): ?>
											<ul class="social-icons">
												<?php echo wp_kses_post($fb);
													...
													echo wp_kses_post($pin);
													echo wp_kses_post($houz);
												?>
							        		</ul>
									    <?php endif; ?>  
				                  	</div>
				...
				<?php
					...
					if($pinterest!=''){
						$pinpopup='<a href="'.$pinterest.'" class="social-icon"><i class="fab fa-pinterest-p"></i></a>';
					}
					if($houzz!=''){
						$houzpopup='<a href="'.$houzz.'" class="social-icon"> <i class="fab fa-houzz"></i> </a>';
					}
				?>
						...
						<div class="col-md-7">
							<div class="rsteam_content">
								<div class="team-content">
									...
									<?php if( $fb || $gp || $tw || $ldin || $houzpopup || $houzpopup ): ?>
								  	<div class="rs-social-icons">
										<div class="social-icons1">
											...
											echo wp_kses_post($pinpopup);
											echo wp_kses_post($houzpopup);
											?>
								        </div>
								  	</div>
								  	<?php endif; ?> 
